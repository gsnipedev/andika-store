...
const MainItem = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ marginTop: 4, backgroundColor: "#FBFBFF", borderRadius: 3 }} disableGutters>
      <Box
        sx={{
      ...
      >
        <div>
          <Typography sx={{ color: "#093A3E", fontSize: 50, fontWeight: "bold" }}>
            <span className="roboto-condensed">Glock 17</span>
          </Typography>
          <Typography sx={{ fontStyle: "italic", color: "#818D92", textAlign: "left" }}>
            <span>
              The Glock G17 is a full-size service pistol, shooting the 9x19mm pistol cartridge
              <br />
